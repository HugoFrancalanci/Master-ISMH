...
c3d_filenames = [
    r"C:\Users\Francalanci Hugo\Desktop\CMP II (10)\Mémoire\Protocole\Motion capture\Code traitement données\Python\Code 3D\Final\habiletes_tests\THM_S1_M9.c3d"
] 
